...
img=["viyogi_notes.png","adi_image_logo.png","covid_logo.png","express_calcy_logo.png",
     "aditya_secura_logo.png","vidat_logo.png","chekaut_logo.png","adi_image_logo.png"]
...
def products():
    ...
    product=["Viyogi Notes","Adi Images","Covid Data","Express-Calcy","Aditya Secura","ViDaT Tool","CheKaut","eighth"]
