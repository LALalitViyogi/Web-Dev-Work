...
@app.route('/')
def main():
    return render_template('home.html',imgs=img,len=main_page_product)
...
def products():
    ...
    product=["Viyogi Notes","Adi Images","Covid Data","Express-Calcy","Aditya Secura","ViDaT Tool","CheKaut","Inserminal"]
